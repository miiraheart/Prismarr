...
class DiscoverController extends AbstractController
{
    public function __construct(
        ...
        private readonly ListsTabContext $lists,
    ) {}

    /**
     * The Lists page is now a tab on the merged Discover page. Kept as a
     * redirect so existing bookmarks still land somewhere useful. Every
     * /lists/* JSON route below is unchanged.
     */
    #[Route('', name: 'index')]
    public function index(): Response
    {
        return $this->redirectToRoute('discover_page', ['tab' => 'lists']);
    }
    ...
    public function lists(Request $request): JsonResponse
    {
        ...
        return $this->json(['lists' => $lists, 'pinned' => $this->lists->pinned()]);
    }
    ...
    public function list(Request $request): JsonResponse
    {
        ...
        return $this->json([
            'items'       => $this->lists->withLibraryStatus($page['items']),
    ...
    public function pin(Request $request): JsonResponse
    {
        ...
        $this->config->set(ListsTabContext::PINNED_KEY, json_encode(array_values($pinned)));
    ...
    public function unpin(Request $request): JsonResponse
    {
        ...
        $this->config->set(ListsTabContext::PINNED_KEY, json_encode($pinned));
